...
const VooponDetail = () => {
  ...
  const [vooponDetail, setVooponDetail] = useState<any>(null); // Holds event details
      ...
      <section className="details-page">
        <div className="container">
          <div className="row">
            ...
            <ClientComponent vooponDetail={vooponDetail} qrCode={vooponDetail?.qr_code_image_one} />
            </div>
        </div>
      </section>
